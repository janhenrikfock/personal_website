...
export default function SocialNav() {
  return (
    <SocialLinkList>
      <li>
        <StyledLink href="https://github.com/janhenrikfock">
          <svg
      ...
      <li>
        <StyledLink href="https://www.xing.com/profile/JanHenrik_Fock2/cv">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="26.998"
            height="31.507"
            viewBox="0 0 26.998 31.507"
          >
            <StyledPath
              id="Icon_awesome-xing"
              data-name="Icon awesome-xing"
              d="M11.44,14.766q-.19.348-4.929,8.684a1.478,1.478,0,0,1-1.245.879H.689a.67.67,0,0,1-.6-1.013l4.852-8.529q.021,0,0-.021L1.856,9.45a.625.625,0,0,1,.6-.991H7.031A1.457,1.457,0,0,1,8.3,9.316ZM26.9,3.241,16.777,21.03v.021l6.441,11.714a.63.63,0,0,1-.6.991H18.035A1.4,1.4,0,0,1,16.77,32.9l-6.5-11.848q.348-.612,10.181-17.944a1.418,1.418,0,0,1,1.23-.858H26.3a.64.64,0,0,1,.6.991Z"
      ...
      <li>
        <StyledLink href="https://www.linkedin.com/in/janhenrikfock/">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="31.5"
            height="31.5"
